...
int main(void) {
	...
	Shader lightShader("Shaders/basic_SpotLightShader.vs", "Shaders/basic_SpotLightShader.fs");
	...
	//	projection = perspective(radians(45.0f), 800.0f / 600.0f, 0.1f, 100.0f);
	  ...
	  // each environment and lighting type requires some tweaking to get the best out of your environment.
		...
		//lightShader.setVec3("directionalLight.direction", -0.2f, -1.0f, -0.3f);
		//lightShader.setVec3("directionalLight.ambient", 0.2f, 0.2f, 0.2f);
		//lightShader.setVec3("directionalLight.diffuse", 0.5f, 0.5f, 0.5f);
		//lightShader.setVec3("directionalLight.specular", 1.0f, 1.0f, 1.0f);
