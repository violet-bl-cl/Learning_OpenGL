...
int main(void) {
	...
	//	projection = perspective(radians(45.0f), 800.0f / 600.0f, 0.1f, 100.0f);
		...
		//cubeShader.setFloat("someUniform", 1.0f); order is very important
		model = mat4(1.0f);
		...
		cubeShader.setVec3("objectColor", (float)sin(glfwGetTime()), (float)sin(glfwGetTime()), (float)sin(glfwGetTime()));
